...
| ng-pipe |  |
| ng-pipe-async | Usage: observable_or_promise_expression |#241; async |
| ng-pipe-currency | Usage: money |#241; currency:'EUR' |
...
| ng-pipe-decimal | Usage: number_expression |#241; decimal[:digitInfo] |
| ng-pipe-example | Angular  Pipe Example |
| ng-pipe-json | Usage: object |#241; json |
| ng-pipe-lowercase |  |
| ng-pipe-percent | Usage: number_expression |#241; percent[:digitInfo] |
| ng-pipe-slice | Usage: array_or_string_expression |#241; slice:start[:end] |
| ng-pipe-uppercase |  |
