...
| ng-pipe |  |
| ng-pipe-async | Usage: observable_or_promise_expression &#007c; async |
| ng-pipe-currency | Usage: money &#007c; currency:'EUR' |
...
| ng-pipe-decimal | Usage: number_expression &#007c; decimal[:digitInfo] |
| ng-pipe-example | Angular  Pipe Example |
| ng-pipe-json | Usage: object &#007c; json |
| ng-pipe-lowercase |  |
| ng-pipe-percent | Usage: number_expression &#007c; percent[:digitInfo] |
| ng-pipe-slice | Usage: array_or_string_expression &#007c; slice:start[:end] |
| ng-pipe-uppercase |  |
